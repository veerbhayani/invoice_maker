...
class AddCompanyDetails extends StatelessWidget {
  ...
  Future<void> saveCompanyDataToSharedPreferences() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();

    prefs.setString('companyName', controller.companyName.value);
    prefs.setString('companyAddress', controller.companyAddress.value);
    prefs.setString('companyAddress2', controller.companyAddress2.value);
    prefs.setString('companyAddress3', controller.companyAddress3.value);
    prefs.setString('companyGSTNo', controller.companyGSTNo.value);
    prefs.setString('companyEmail', controller.companyEmail.value);
    prefs.setString('companyNumber', controller.companyNumber.value);
    prefs.setString('selectedImagePath', controller.selectedImagePath.value);
    prefs.setInt('companyTax', controller.initialTaxValue.value);
  }
